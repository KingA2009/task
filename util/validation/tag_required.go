...
func ValidationStructTag(loggers *logrus_log.Logger, model interface{}) error {
...
func RegexRequired(regexValue string, fieldValue reflect.Value,
	fieldName string, loggers *logrus_log.Logger) error {
	switch regexValue {
	case loginRegex:
...
func TagRequired(requiredTagValue, fieldValue, fieldName string, loggers *logrus_log.Logger) error {
...
func LengthRequired(fieldValue, fieldName, lenMinTagValue, lenMaxTagValue string, loggers *logrus_log.Logger) error {
...
func AmountRequired(fieldValue int, fieldName,
	...
	loggers *logrus_log.Logger) error {
